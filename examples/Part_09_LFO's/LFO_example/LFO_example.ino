...
void loop(){
  ...
  if(VCC.MODE==0){ 
    if(VCC.SUBMODE==0){ 
      ...
      //In this LFO we are creating an sin wave with a frequency defined by our manual “0” input, multiply it by “1”, with no offset and a 
      //bottom of “0” and top of “1” 
      LFO1.sinMode(false,  VCC.ReadManual(A,0)*1000.0f, 1, 0, 0, 1);
      // create a cosine wave with the same parameters
      LFO2.cosinMode(true, VCC.ReadManual(A,1)*1000.0f, 1, 0, 0, 1);
