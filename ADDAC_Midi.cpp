...
/*! \brief Default constructor for ADDAC_Midi. */
ADDAC_Midi::ADDAC_Midi()
{ 
...
/*! \brief Default destructor for ADDAC_Midi.
...
/*! \brief Call the begin method in the setup() function of the Arduino.
 ...
 - Full thru mirroring
 */
void ADDAC_Midi::begin(const byte inChannel)
{
...
const byte ADDAC_Midi::genstatus(const kMIDIType inType,
 ...
 */
void ADDAC_Midi::send(kMIDIType type,
					  byte data1,
					  byte data2,
					  byte channel)
{
 ...
 */
void ADDAC_Midi::sendNoteOn(byte NoteNumber,
							byte Velocity,
							byte Channel)
{ 
...
/*! \brief Send a Note Off message (a real Note Off, not a Note On with null velocity)
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void ADDAC_Midi::sendNoteOff(byte NoteNumber,
							 byte Velocity,
							 byte Channel)
{
...
/*! \brief Send a Program Change message 
 ...
 \param Channel			The channel on which the message will be sent (1 to 16).
 */
void ADDAC_Midi::sendProgramChange(byte ProgramNumber,
								   byte Channel)
{
...
/*! \brief Send a Control Change message 
 ...
 \param Channel			The channel on which the message will be sent (1 to 16). 
 */
void ADDAC_Midi::sendControlChange(byte ControlNumber,
								   byte ControlValue,
								   byte Channel)
{
...
/*! \brief Send a Polyphonic AfterTouch message (applies to only one specified note)
 ...
 \param Channel			The channel on which the message will be sent (1 to 16). 
 */
void ADDAC_Midi::sendPolyPressure(byte NoteNumber,
								  byte Pressure,
								  byte Channel)
{
...
/*! \brief Send a MonoPhonic AfterTouch message (applies to all notes)
 ...
 \param Channel			The channel on which the message will be sent (1 to 16). 
 */
void ADDAC_Midi::sendAfterTouch(byte Pressure,
								byte Channel)
{
...
/*! \brief Send a Pitch Bend message using a signed integer value.
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void ADDAC_Midi::sendPitchBend(int PitchValue,
							   byte Channel)
{
...
/*! \brief Send a Pitch Bend message using an unsigned integer value.
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void ADDAC_Midi::sendPitchBend(unsigned int PitchValue,
							   byte Channel)
{
...
/*! \brief Send a Pitch Bend message using a floating point value.
 ...
 \param Channel		The channel on which the message will be sent (1 to 16).
 */
void ADDAC_Midi::sendPitchBend(double PitchValue,
							   byte Channel)
{
 ...
 */
void ADDAC_Midi::sendSysEx(int length,
 ...
 */
void ADDAC_Midi::sendTuneRequest()
{
 ...
 */
void ADDAC_Midi::sendTimeCodeQuarterFrame(byte TypeNibble, byte ValuesNibble)
{
 ...
 */
void ADDAC_Midi::sendTimeCodeQuarterFrame(byte data)
{
 ...
 */
void ADDAC_Midi::sendSongPosition(unsigned int Beats)
{
...
void ADDAC_Midi::sendSongSelect(byte SongNumber)
{
...
/*! \brief Send a Real Time (one byte) message. 
 ...
 @see kMIDIType
 */
void ADDAC_Midi::sendRealTime(kMIDIType Type)
{
	switch (Type) {
...
bool ADDAC_Midi::parse(byte inChannel)
{ 
...
bool ADDAC_Midi::input_filter(byte inChannel)
{
...
void ADDAC_Midi::reset_input_attributes()
{
 ...
 */
kMIDIType ADDAC_Midi::getType() const
{
 ...
 */
byte ADDAC_Midi::getChannel() const
{
...
byte ADDAC_Midi::getData1() const
{
...
byte ADDAC_Midi::getData2() const
{ 
 ...
 */
const byte * ADDAC_Midi::getSysExArray() const
{ 
 ...
 */
unsigned int ADDAC_Midi::getSysExArrayLength() const
{
 ...
 */
void ADDAC_Midi::setInputChannel(const byte Channel)
{ 
...
void ADDAC_Midi::setHandleNoteOff(void (*fptr)(byte channel, byte note, byte velocity))			{ mNoteOffCallback = fptr; }
void ADDAC_Midi::setHandleNoteOn(void (*fptr)(byte channel, byte note, byte velocity))			{ mNoteOnCallback = fptr; }
void ADDAC_Midi::setHandleAfterTouchPoly(void (*fptr)(byte channel, byte note, byte pressure))	{ mAfterTouchPolyCallback = fptr; }
void ADDAC_Midi::setHandleControlChange(void (*fptr)(byte channel, byte number, byte value))	{ mControlChangeCallback = fptr; }
void ADDAC_Midi::setHandleProgramChange(void (*fptr)(byte channel, byte number))				{ mProgramChangeCallback = fptr; }
void ADDAC_Midi::setHandleAfterTouchChannel(void (*fptr)(byte channel, byte pressure))			{ mAfterTouchChannelCallback = fptr; }
void ADDAC_Midi::setHandlePitchBend(void (*fptr)(byte channel, int bend))						{ mPitchBendCallback = fptr; }
void ADDAC_Midi::setHandleSystemExclusive(void (*fptr)(byte * array, byte size))				{ mSystemExclusiveCallback = fptr; }
void ADDAC_Midi::setHandleTimeCodeQuarterFrame(void (*fptr)(byte data))							{ mTimeCodeQuarterFrameCallback = fptr; }
void ADDAC_Midi::setHandleSongPosition(void (*fptr)(unsigned int beats))						{ mSongPositionCallback = fptr; }
void ADDAC_Midi::setHandleSongSelect(void (*fptr)(byte songnumber))								{ mSongSelectCallback = fptr; }
void ADDAC_Midi::setHandleTuneRequest(void (*fptr)(void))										{ mTuneRequestCallback = fptr; }
void ADDAC_Midi::setHandleClock(void (*fptr)(void))												{ mClockCallback = fptr; }
void ADDAC_Midi::setHandleStart(void (*fptr)(void))												{ mStartCallback = fptr; }
void ADDAC_Midi::setHandleContinue(void (*fptr)(void))											{ mContinueCallback = fptr; }
void ADDAC_Midi::setHandleStop(void (*fptr)(void))												{ mStopCallback = fptr; }
void ADDAC_Midi::setHandleActiveSensing(void (*fptr)(void))										{ mActiveSensingCallback = fptr; }
void ADDAC_Midi::setHandleSystemReset(void (*fptr)(void))										{ mSystemResetCallback = fptr; }
 ...
 */
void ADDAC_Midi::disconnectCallbackFromType(kMIDIType Type)
{
...
void ADDAC_Midi::launchCallback()
{
...
/*! \brief Set the filter for thru mirroring
 ...
 @see kThruFilterMode
 */
void ADDAC_Midi::setThruFilterMode(kThruFilterMode inThruFilterMode)
{ 
...
void ADDAC_Midi::turnThruOn(kThruFilterMode inThruFilterMode)
{ 
...
void ADDAC_Midi::thru_filter(byte inChannel)
{
